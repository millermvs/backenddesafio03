package br.com.desafio.infrastructure.configurations;
...
public class SwaggerConfiguration {
	...
	public OpenAPI customOpenAPI() {
		return new OpenAPI()
				// Informações da API
				.info(new Info().title("API DESAFIO03").version("1.0.0")
						.description("API REST para gerenciamento de clientes, usuários e permissões")
						.termsOfService("https://meusite.com.br")
						.contact(new Contact().name("Suporte Técnico").email("suporte@meusite.com")
